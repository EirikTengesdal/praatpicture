...
praatpicture <- function(sound,
                         ...
                         oma = c(5, 5, 5, 5),
                         mgp = c(3, 1, 0), # Default
                         xmgp = c(3, 0.2, 0), # For adjusting time (x) axis margin line for tick labels
                         lwd = 1, # Default
                         ystd = TRUE,
                         mtext_cex = 0.8,
                         wave_channels = 'all',
